...
public class CurrentWatchingMoviesRecyclerAdapter extends RecyclerView.Adapter<CurrentWatchingMoviesRecyclerAdapter.PopularMoviesHolder> {
    private final List<MovieItem> movieItemList;
    private ItemClickListener clickListener;

    public CurrentWatchingMoviesRecyclerAdapter() {
