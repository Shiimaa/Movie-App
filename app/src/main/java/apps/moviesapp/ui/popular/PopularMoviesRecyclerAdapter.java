...
public class PopularMoviesRecyclerAdapter extends RecyclerView.Adapter<PopularMoviesRecyclerAdapter.PopularMoviesHolder> {
    private List<MovieItem> movieItemList;
    private ItemClickListener clickListener;

    public PopularMoviesRecyclerAdapter() {
